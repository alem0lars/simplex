...
/**
 * Represents a standard linear model
 */
public final class StandardLinearModel extends GeneralLinearModel {

  // { Constructors and Factories

  /**
   * Never call this method. If you need to create a new StandardLinearModel, use the factory method
   * instead, which also converts the arguments to create a standard linear model which is valid
   * @param constraints The constraints
   * @param objfunc The objective-function
   * @param objective The objective for the model (e.g. minimize)
   */
  private StandardLinearModel(List<ImmutableLinearConstraint> constraints, ImmutableLinearObjfunc objfunc,
                             Objective objective, List<ImmutableSolution> solutionHistory) {
    super(constraints, objfunc, objective, solutionHistory);
  }

  /**
   * Create a new valid standard linear model
   * @param constraints The constraints
   * @param objfunc The objective-function
   * @param objective The objective for the model (e.g. minimize)
   * @return The created model
   */
  public static LinearModel create(List<ImmutableLinearConstraint> constraints, ImmutableLinearObjfunc objfunc,
                                    Objective objective, List<ImmutableSolution> solutionHistory) {
    return new StandardLinearModel(constraints, objfunc, objective, solutionHistory);
  }

  /**
   * Convert the linear model passed as argument into a standard linear model
   * @param model The model to be converted
   * @return The new model as standard linear model equivalent to the model argument
   */
  public static LinearModel create(LinearModel model) {
    return StandardLinearModel.create(model.getConstraints(), model.getObjfunc(),
  ...
  public LinearModel duplicate(List<ImmutableLinearConstraint> constraints,
    ...
    return StandardLinearModel.create(model);
  }

  /**
   * Check if the current model is a valid standard linear model
   * @return Valid or not
   */
  @Override
